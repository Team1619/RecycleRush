...
//	public static final double k0TotePosition = 1.0, k1TotePosition = 2.0, k2TotePosition = 3.0, k3TotePosition = 4.0, k4TotePosition = 5.0, k5TotePosition = 6.0;
	...
	*/
	...
	private UToteElevatorSystem() {
		toteElevatorMotor = URobotMap.MotorDefinition.toteElevatorMotor.getMotor();
		...
		toteElevatorMotorSmall = URobotMap.MotorDefinition.toteElevatorMotorSmall.getMotor();
		...
		toteElevatorMotorSmall.set(URobotMap.MotorDefinition.toteElevatorMotor.id);
...
//				setToteElevatorPosition(getToteElevatorPosition());
		...
		if(finalSetValuePosition) {
			...
			if(finalSetValue > UBinElevatorSystem.kToteElevatorSafetyForTilt) {
				toteElevatorMotor.set(UBinElevatorSystem.kToteElevatorSafetyForTilt);
			}
			else {
				toteElevatorMotor.set(finalSetValue);
			}
