...
public class URobot extends IterativeRobot {
	...
	public void sharedPeriodic() {
		...
		SmartDashboard.putBoolean("binElevator Fwd Limit", UBinElevatorSystem.getInstance().fBinElevatorMotor.isFwdLimitSwitchClosed());
		SmartDashboard.putBoolean("binElevator Rev Limit", UBinElevatorSystem.getInstance().fBinElevatorMotor.isRevLimitSwitchClosed());
		SmartDashboard.putBoolean("binTilt Fwd Limit", UBinElevatorSystem.getInstance().fTilterMotor.isFwdLimitSwitchClosed());
		SmartDashboard.putBoolean("binTilt Rev Limit", UBinElevatorSystem.getInstance().fTilterMotor.isRevLimitSwitchClosed());
		...
		SmartDashboard.putNumber("binElevatorMotor.getOutputVoltage()", UBinElevatorSystem.getInstance().fBinElevatorMotor.getOutputVoltage());
		SmartDashboard.putNumber("binElevatorMotor.getOutputCurrent()", UBinElevatorSystem.getInstance().fBinElevatorMotor.getOutputCurrent());
		...
		// RobotMap.MotorDefinition[] motorDefinitions =
		// RobotMap.MotorDefinition.values();
		// String[] motorLumberjackValues= new String[motorDefinitions.length *
		// 2];
		// for(int i = 0, j = 0, len = motorLumberjackValues.length; i < len;
		// i+=2, j++) {
		// motorLumberjackValues[i] =
		// Double.toString(motorDefinitions[j].getMotor().getOutputCurrent());
		// motorLumberjackValues[i + 1] =
		// Double.toString(motorDefinitions[j].getMotor().getOutputVoltage());
		// }
