...
public class UMoveBinElevator extends Command {
    ...
    protected boolean isFinished() {
    	if(!toEnd) {
    		...
    		if(up) {
    			return UBinElevatorSystem.getInstance().binElevatorMotor.isRevLimitSwitchClosed();
    		}
    		else {
    			return UBinElevatorSystem.getInstance().binElevatorMotor.isFwdLimitSwitchClosed();
    		}
    	}
    }
